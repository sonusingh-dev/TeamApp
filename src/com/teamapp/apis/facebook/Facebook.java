...
public class Facebook {
	...
	public void authorize(Activity activity, final DialogListener listener) {
		authorize(activity, new String[] {}, -1, listener);
	}
	...
	public void authorize(Activity activity, String[] permissions,
		...
		authorize(activity, permissions, -1, listener);
	}
	...
	public boolean isSessionValid() {
		Log.d("OKEY", "getAccessToken " + (getAccessToken() != null));
		Log.d("OKEY", "getAccessExpires " + (getAccessExpires() == 0));
		Log.d("OKEY", "currentTimeMillis "
